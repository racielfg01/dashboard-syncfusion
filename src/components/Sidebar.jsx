...
const handleCloseSideBar=()=>{
  ...
  pb-2.5 rounded-lg text-md text-gray-700
  dark:text-gray-200 dark:hover:text-black 
  hover:bg-ligth-gray m-2 `;
    ...
    {links.map((items,i)=>(
     ...
     >
        ...
        {items.links.map(link=>(
          ...
          <NavLink to={`/${link.name==='home'?"":link.name}`} key={link.name}
