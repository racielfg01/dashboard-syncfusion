...
import { Stacked, Pie, Button, SparkLine, Categories,Sales,FlexContent } from "../components";
  ...
  return (
    <div className=" mt-16  mx-8">
      ...
      <div className="flex justify-center">
        ...
        h-56 rounded-xl w-full p-8 pt-9 m-3 bg-hero-pattern
      ...
      {/* <div className="flex flex-col mt-5  dark:text-gray-200">
        <div className="flex justify-around items-center">
          <p className="font-semibold text-xl">Últimas Ventas </p>
          <button>ver mas</button>
        </div>
        <div className="flex m-3  gap-3 items-center overflow-auto hover:overflow-scroll">
